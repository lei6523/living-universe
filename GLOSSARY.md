...
| 英文名称 | 中文名称 | 定义 |
| --- | --- | --- |
| Living Universe | 活宇宙 / 持续叙事文明 | 由大量人类创作者共同创造、由 AI 基础设施维护的持续叙事文明；故事可以提出事实，事实可以进入历史，历史会产生后果，世界既保存真实发生过什么，也保存人们如何记录与理解历史。 |
| Persistent Narrative Civilization | 持续叙事文明 | Living Universe 的目标定位：不同于共享宇宙（Shared Universe）、协作写作平台（Collaborative Writing Platform）或 AI 故事生成器（AI Story Generator）的新型叙事形态。 |
| Narrative Artifact | 叙事作品 | 故事本身：永远独立存在的作品，不因正史变化而消失。 |
| Claim | 事实主张 | 故事提出的关于世界的断言；包含主体、关系、对象、有效时间、来源与状态。 |
| Claim Layer | 事实主张层 | 故事与世界事实之间的中间层：创作内容不直接等于真相，作者首先提出主张。 |
| World Reality | 世界现实 | Living Universe 当前认定真正发生过的事情；不等于任何单一叙事或记录。 |
| Reality Canon | 现实正史 | 构成 World Reality 的已确认事实集合；主张经过验证与人工审核后进入。 |
...
| Epistemic Layer | 认知层 | 知识认知状态的层次：真实、错误、未知、争议、部分真实、被认为真实、宣传、未验证。 |
| Canon White Space | 正史空白区 | 世界中尚未定义、部分定义或保持开放的区域；UNKNOWN 不等于 FALSE。 |
| Canon Reframing | 正史重构 / 再语境化 | 旧正史内容重新语境化的机制：正史事实可以被重新认识，历史作品本身不会消失。 |
| Canon Engine | 正史引擎 | 验证事实主张与世界现实兼容性的整体系统，包含多个检查器。 |
| Canon Compiler | 正史编译器 | Canon Engine 的组成部分：像程序编译器检查代码一样检查故事与世界的一致性。 |
| Canon AI | 正史 AI | 语义验证器（Semantic Validator）：不创造真相，只验证新主张与已有世界现实的兼容性。 |
| Canon Conflict | 正史冲突 | 主张与既有正史不一致的情况，如时间线、科技、地理、人物状态等矛盾。 |
